...
class fm_project(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.center_freq = center_freq = 96.9e6
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._center_freq_range = Range(80.1e6, 108.1e6, 200000, 96.9e6, 200)
        ...
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink('/home/popuser/SDR-Speech-Recognition/app/audios/output.wav', 1, 48000, 8)
        ...
        self.connect((self.blocks_throttle_0, 0), (self.blocks_tcp_server_sink_0, 0))
